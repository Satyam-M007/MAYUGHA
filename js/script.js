...
const birthdayDate = new Date('2024-04-12T00:00:00');
...
function updateCountdown() {
    ...
    const isBirthday = currentDate.getDate() === 12 && currentDate.getMonth() === 3; // April is month 3

    if (isBirthday) {
        // Show birthday message
        document.querySelector('.countdown-container').style.display = 'none';
        document.querySelector('.happy-birthday').textContent = 'Congratulations MAYUGHA, you are 18 now!';
